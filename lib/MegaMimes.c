...
{	
	...
	{"*.jpeg", "Raw JPEG Stream", "image/jpeg", "0"},
    {"*.numbers", "Custom", "application/vnd.apple.numbers", "0"},
    {"*.numbers", "Custom", "application/vnd.apple.numbers", "0"},
    {"*.key", "Custom", "application/vnd.apple.keynote", "0"},
    {"*.pages", "Custom", "application/vnd.apple.pages", "0"},
	{NULL, NULL, NULL, NULL }	
};
